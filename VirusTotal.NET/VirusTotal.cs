...
namespace VirusTotalNET
{
    public partial class VirusTotal
    {
        ...
        private readonly string _apiKey = "ba3dd0bfaceb4191eff8a8e1dc673807d2a1eea1451074eef75afc7b78b344b6";
        ...
        {
            apiKey = "ba3dd0bfaceb4191eff8a8e1dc673807d2a1eea1451074eef75afc7b78b344b6";
            if (string.IsNullOrEmpty(apiKey) || apiKey.Length < 64)
                throw new ArgumentException("Need an API Key.", "apiKey");
